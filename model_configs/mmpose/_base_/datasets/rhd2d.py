dataset_info = dict(
    ...
    keypoint_info={
        ...
        5:
        dict(name='forefinger4', id=5, color=[255, 153, 255], type='',
             swap=''),
        6:
        dict(name='forefinger3', id=6, color=[255, 153, 255], type='',
             swap=''),
        7:
        dict(name='forefinger2', id=7, color=[255, 153, 255], type='',
             swap=''),
        8:
        dict(name='forefinger1', id=8, color=[255, 153, 255], type='',
             swap=''),
        9:
        ...
        dict(name='middle_finger1',
             ...
             swap=''),
        13:
        dict(name='ring_finger4', id=13, color=[255, 51, 51], type='',
             swap=''),
        14:
        dict(name='ring_finger3', id=14, color=[255, 51, 51], type='',
             swap=''),
        15:
        dict(name='ring_finger2', id=15, color=[255, 51, 51], type='',
             swap=''),
        16:
        dict(name='ring_finger1', id=16, color=[255, 51, 51], type='',
             swap=''),
        17:
