dataset_info = dict(
    ...
    skeleton_info={
        0: dict(link=('right_wrist', 'right_elbow'), id=0, color=[255, 128,
                                                                  0]),
        1: dict(link=('right_elbow', 'right_shoulder'),
                id=1,
                color=[255, 128, 0]),
        ...
        12: dict(link=('right_shoulder', 'right_hip'),
                 id=12,
                 color=[51, 153, 255]),
        13: dict(link=('left_shoulder', 'left_hip'),
                 id=13,
                 color=[51, 153, 255])
    },
    joint_weights=[
