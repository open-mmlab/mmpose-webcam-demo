_base_ = ['./_base_/default_runtime.py', './_base_/datasets/animalpose.py']
...
train_pipeline = [
    ...
    dict(type='TopDownHalfBodyTransform',
         ...
         prob_half_body=0.3),
    dict(type='TopDownGetRandomScaleRotation', rot_factor=40,
         scale_factor=0.5),
